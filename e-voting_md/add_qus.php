					...
					<div id="content" >	
						<div style="background:white;margin-top:-10px;margin-bottom:60px;min-height:500px">	
							...
							<input type="radio" class="" name="quest_cat" value="syllabus" checked> Syllabus
								...
								<textarea  name="question" class="form-control" id="throwByEditor"></textarea>
								</div></div>	<br/>
							...
							{
								extract($_POST);
								$insert=mysql_query("INSERT INTO `question` ( `sid`, `question`, `sub_code`, `unit`, `type`, `quest_cat`) VALUES ( '$sid', '$question', '$sub_code', '$unit', '$type', '$quest_cat')");
								if($insert){
