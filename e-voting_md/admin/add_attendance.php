			...
			<div class="col-lg-12 ">
					...
					<div class="panel-body">
						...
						<form name="addForm" id="addForm" method="post" action="" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-3">
									<div class="row pad20">
										<label class="col-md-12 col-xs-12 mtop10">Staff Id<span>*</span> </label>
										<input type="text" class="col-md-12 col-xs-12 mtop10" name="sid" autocomplete="off" required/>
									</div>
								</div>
								
								<div class="col-md-3">
									<div class="row pad20">
										<label class="col-md-12 col-xs-12 mtop10">Status<span>*</span> </label>
										<select name="status" class="col-md-12 col-xs-12 mtop10" required >
							...
							<div class="row">
								...
								<div class="col-md-7">
									<div class="row pad20">
										<input type="submit" name="s1" value="Add Attendance" class="btn btn-primary btn-add mtop10 mleft20 col-md-3"> 
				...
				<?php
					if(isset($_POST['s1']))
					{
						...
						$qry=mysql_query("insert into attendance(sid,adate,status,time_in)values('$sid','$adate','$status','$time_in')");
