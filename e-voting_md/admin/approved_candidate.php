					...
					<!-- /.panel-heading -->
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<tbody id="user-area">
									<?php  
										$select=mysql_query("select * from condidate where status=1");
									...
									<tr class="odd gradeX">
										...
										<?php 
										$cid=$row['cid'];
											$sel=mysql_query("select * from allocate_party where cid=$cid");
											$n=mysql_num_rows($sel);
											$fetch2=mysql_fetch_array($sel);
										if($n==1){
											echo $fetch2['party'];
											?><br/><img src="images/party/<?php echo $fetch2['symbol'];?>" height="80" width="80">
										<?php }else{
											
										?><a href="allocate_party.php?cid=<?php echo $row['cid'] ?>" class="btn btn-primary btn-view mtop2" role="button" data-toggle="modal"> 
												Allocate Party
										</a><?php } ?></td>
