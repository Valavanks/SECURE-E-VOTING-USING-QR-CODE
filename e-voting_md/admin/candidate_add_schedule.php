				...
				<div class="panel panel-default bg-white">
						...
						<span style="padding:20px 20px;text-align:center;"><h2>Add Schedule </h2></span>
						 ...
						 <form action="#" method="post" enctype="multipart/form-data" style="max-width:500px;margin:auto">
							  ...
							  <div class="input-container">
								<i class="fa fa-use icon">Time</i>
								<input class="input-field" type="text" placeholder="09.00AM To 05.00PM" name="time">
							  </div>
							  ...
							  <div class="input-container">
											...
											<input class="input-field" type="text" placeholder="District" name="state">	
								</div>
							...
							<?php
								...
								if(isset($_POST['election']))
								{
									...
									(`ename` ,`date`,`time` ,`eplace` ,`state`)VALUES (
										 '$ename',  '$date','$time',  '$place',  '$state')");
									if($insert)
									{
