		...
		<div class="row-fluid mtop120">
			<div class="col-lg-12 ">
				<div class="panel panel-default bg-white">
						...
						<?php
						$sid=$_REQUEST['sid'];
								$qry=mysql_query("select * from staff where sid=$sid");
					...
					<div class="panel-body">
						...
						<form name="addForm" id="addForm" method="post" action="" enctype="multipart/form-data">
							<div class="row">
								<div class="col-md-3">
									<div class="row pad20">
										...
										<input type="text" class="col-md-12 col-xs-12 mtop10" name="sname" value="<?php echo $row['sname']; ?>" autocomplete="off" required/>
									</div>
								</div>
								<div class="col-md-3">
									<div class="row pad20">
										<label class="col-md-12 col-xs-12 mtop10">Qualification<span>*</span> </label>
										<input type="text" class="col-md-12 col-xs-12 mtop10" value="<?php echo $row['qualification']; ?>" name="qualification" autocomplete="off" required/>
									</div>
								</div>
								<div class="col-md-3">
									<div class="row pad20">
										<label class="col-md-12 col-xs-12 mtop10">Designation<span>*</span> </label>
										<input type="text" class="col-md-12 col-xs-12 mtop10" value="<?php echo $row['designation']; ?>" name="designation" autocomplete="off" required />
									</div>
								</div>
								<div class="col-md-3">
									<div class="row pad20">
										<label class="col-md-12 col-xs-12 mtop10">Department<span>*</span> </label>
										<input type="text" class="col-md-12 col-xs-12 mtop10" name="dept" autocomplete="off" value="<?php echo $row['dept']; ?>" required />
									</div>
								</div>
								<div class="col-md-3">
									<div class="row pad20">
										<label class="col-md-12 col-xs-12 mtop10">Mobile<span>*</span> </label>
										<input type="text" class="col-md-12 col-xs-12 mtop10" name="mobile" autocomplete="off" value="<?php echo $row['mobile']; ?>" required/>
									</div>
								</div>
								<div class="col-md-3">
									<div class="row pad20">
										<label class="col-md-12 col-xs-12 mtop10">Email<span>*</span> </label>
										<input type="text" class="col-md-12 col-xs-12 mtop10" name="email" autocomplete="off" value="<?php echo $row['email']; ?>" required/>
									</div>
								</div>
								<div class="col-md-3">
									<div class="row pad20">
										<label class="col-md-12 col-xs-12 mtop10">Address<span>*</span> </label>
										<input type="text" class="col-md-12 col-xs-12 mtop10" name="address" autocomplete="off" value="<?php echo $row['address']; ?>" required/>
									</div>
								</div>
								<div class="col-md-3">
									<div class="row pad20">
										<label class="col-md-12 col-xs-12 mtop10">Photo<span>*</span> </label>
										<img src="staff_image/<?php echo $row['photo']; ?>" width="100" height="100"><br>
										<input type="file" class="col-md-12 col-xs-12 mtop10" name="photo" autocomplete="off" />
										<input type="hidden" class="col-md-12 col-xs-12 mtop10" name="sphoto" value="<?php echo $row['photo']; ?>"autocomplete="off" required/>
									</div>
								</div>
								<div class="col-md-3">
									<div class="row pad20">
										<label class="col-md-12 col-xs-12 mtop10">Password<span>*</span> </label>
										<input type="password" class="col-md-12 col-xs-12 mtop10" name="pwd" value="<?php echo $row['pwd']; ?>"autocomplete="off" required/>
									</div>
								</div>
							</div><br/>
							...
							<div class="row">
								...
								<div class="col-md-7">
									<div class="row pad20">
										<input type="submit" name="s1" value="Update Staff Detail" class="btn btn-primary btn-add mtop10 mleft20 col-md-3"> 
				...
				<?php
					if(isset($_POST['s1']))
					{
						...
						$qry=mysql_query("update staff set sname='$sname',qualification='$qualification',designation='$designation',dept='$dept',mobile='$mobile',email='$email',address='$address',photo='$photo',pwd='$pwd' where sid=$sid");
