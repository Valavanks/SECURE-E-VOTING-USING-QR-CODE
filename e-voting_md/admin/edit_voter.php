				...
				<div class="panel panel-default bg-white">
					...
					<!-- /.panel-heading -->
						...
						<?php
							include "dbcc.php";
							$vid=$_REQUEST['vid'];
							$select=mysql_query("select * from voter where vid=$vid");
						...
						<span style="padding:20px 20px;text-align:center;"><h2>Add Voter List </h2></span>
						 ...
						 <form action="#" method="post" enctype="multipart/form-data" style="max-width:500px;margin:auto">
							  ...
							  <div class="input-container">
								...
								<input class="input-field" type="text" value="<?php echo $row['name'] ?>" placeholder="candidate name" name="name">
							  </div>
							   <div class="input-container">
								<i class="fa fa-calender icon">photo</i>
								<img src="images/voter/<?php echo $row['photo'] ?>" height="100" width="100">
							  </div>
							   <div class="input-container">
							  ...
							  <div class="input-container">
								<i class="fa fa-user icon"></i>
								<input class="input-field" type="text" value="<?php echo $row['father_name'] ?>" placeholder="Father name" name="father_name">
							  </div>
							  ...
							  <div class="input-container">
								...
								<input class="input-field" value="<?php echo $row['dob'] ?>" type="date" placeholder="DOB" name="dob">
							  </div>
							  
							  <div class="input-container">
								<i class="fa fa-phone icon"></i>
								<textarea class="input-field" value="<?php echo $row['address'] ?>"  placeholder="Address" name="address"></textarea>
							  </div>
						...
						$update=mysql_query("update voter set name='$name',photo='$photo',father_name='$father_name',
						gender='$gender',dob='$dob',address='$address' where vid=$vid");
						if($update)
						{
