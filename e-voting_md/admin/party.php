				...
				<div class="panel panel-default bg-white">
						...
						<span style="padding:20px 20px;text-align:center;"><h2>Allocate Party </h2></span>
						 ...
						 <form action="#" method="post" enctype="multipart/form-data" style="max-width:500px;margin:auto">
								...
								<center><img style="margin-left:191px;border:1px;border-radius:50%" src="../candidate/<?php echo $row['photo'] ?>"></center>
							  </div>
							  <div class="input-container">
								
								<input class="input-field" type="text" placeholder="" value="<?php echo $row['name'] ?>" name="ename">
							  </div>
							  ...
							  <div class="input-container">
								...
								<div class="input-container">
								<i class="fa fa-envelo icon">Party image</i>
