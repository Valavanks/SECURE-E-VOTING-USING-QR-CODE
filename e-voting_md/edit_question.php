...
<!Doctype html>
	...
	<body style="background:#dcd5bc">
		<?php 
			...
			include "session.php";
			$id=$_REQUEST['qid'];
			$sub=mysql_query("select * from question where q_id='$id'");
				...
				<div class="col-lg-12">
					...
					<div id="content" >	
						<div style="background:white;margin-top:-10px;margin-bottom:60px;min-height:500px">	
							<div class="container">
							<a href="upload_question.php" class="btn btn-warning" style="float:right; margin:20px;color:white">Upload Question</a>
							<form method="post">
							<div class="row">
							<div class="col-sm-6">
							...
							<select class="form-control" name="type">
								...
								<option value="13m"> 13 Marks</option>
								<option value="15m"> 15 Marks</option>
							...
							<input type="radio" class="" name="quest_cat" value="application"> Application
							<input type="radio" class="" name="quest_cat" value="syllabus" checked> Syllabus
								
								
								</div>
								<div class="col-sm-12">
								<label>Question:</label>
								<textarea  name="question" class="form-control" id="throwByEditor"><?php echo $row['question']; ?></textarea>
								</div></div>	<br/>
							...
							{
								extract($_POST);
								$insert=mysql_query("update `question` set `sid`='$sid', `question`='$question', `sub_code`='$sub_code', `unit`='$unit', `type`='$type', `quest_cat`='$quest_cat' where q_id=$id");
								if($insert){
									echo "<script>alert('success')
									window.href='question.php'</script>";
								}else{
		...
		<!-- wrapper ends-->
		<script src="admin/dist/js/trumbowyg.min.js"></script>
	
   
	<script>
	
		$('#throwByEditor').trumbowyg();
		$(function () 
			{
	...
	<script src="admin/dist/plugins/upload/trumbowyg.upload.js"></script>
	</body>
