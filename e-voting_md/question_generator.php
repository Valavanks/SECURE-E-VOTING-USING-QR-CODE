				...
				<div class="col-lg-12">
					...
					<div id="content" >	
						<div style="background:white;margin-top:-10px;margin-bottom:60px;min-height:500px">	
							...
							<div class="row">
							<div class="col-sm-12 ">
							<h1 class="text-center">Question Paper Generator</h1>
							<div class="row">
							<div class="col-sm-4 bg-green">
							<a href="question_5unit.php" style="color:white;text-decoration:none">
							<h2>5 Units</h2>
							</div></a>
							<div class="col-sm-4 bg-blue">
							<a href="question_3unit.php" style="color:white;text-decoration:none">
							<h2>3 Units</h2>
							</div></a>
							<div class="col-sm-4 bg-red">
							<a href="question_1unit.php" style="color:white;text-decoration:none">
							<h2>1 Unit</h2>
							</div></a>
							</div>
  ...
  <div class="form-group">
    <input type="submit" name="sub" class="btn btn-primary" value="Proceed">
							...
							$u5_2m=getQuestions(2,'2m',5,$sub_code);
								...
								$u1_15m=getQuestions(2,'15m',1,$sub_code);	
								$u4_15m=getQuestions(2,'15m',4,$sub_code);	
