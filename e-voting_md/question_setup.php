					...
					<div style="margin-top:-10px">
						<nav class="navbar navbar-expand-sm bg-light">
							<ul class="navbar-nav">
								...
								<li class="nav-item">
									<a class="nav-link active" id="sss" href="question_setup.php">Question SetUp</a>
								</li>
								<li class="nav-item">
					...
					<div id="content" >	
						<div style="background:white;margin-top:-10px;margin-bottom:60px;min-height:500px">	
							...
							<select class="form-control" name="unit_type">
								...
								<input type="checkbox" class="checkbox " value="1"> Unit - 1
								<input type="checkbox" class="checkbox " value="2"> Unit - 2
								<input type="checkbox" class="checkbox " value="3"> Unit - 3
								<input type="checkbox" class="checkbox " value="4"> Unit - 4
								<input type="checkbox" class="checkbox " value="5"> Unit - 5
							...
							{
								extract($_POST);
								$insert=mysql_query("INSERT INTO `question` ( `sid`, `question`, `sub_code`, `unit`, `type`) VALUES ( '$sid', '$question', '$sub_code', '$unit', '$type')");
								if($insert){
