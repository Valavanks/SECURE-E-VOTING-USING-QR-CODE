  ...
  border: 2px solid black;
	...
	<body style="background:#dcd5bc">
		<?php
			...
			$select=mysql_query("select * from question_bank where author='$sid'");
				?>
		<!-- wrapper starts-->
				...
				<div class="col-lg-12">
					...
					<div id="content"> 	
						<div style="background:white;margin-top:-50px;margin-bottom:60px;min-height:500px;">	
							...
							<br><br/><center class="head">QUESTION BANK</center><br><br/>
							<center>
								<table class="" cellpadding="5" style="width:75%;">
								<tr><th style="width:100px">S.NO</th>
								<th style="width:100px">Question Title</th>
								<th style="width:100px">Subject Code</th>
								<th style="width:100px">Date</th>
								<th style="width:100px">Question Category</th>
								...
								<th style="width:100px">Delete</th>
									...
									while($row=mysql_fetch_array($select)){ ?>
										...
										<td style="text-align:left;font-size:18px;padding:5px;"><a href="delete_bank.php?qbid=<?php echo $row['qbid']; ?>" class="btn btn-danger">Delete</a></td></tr>
									<?php $i++;	}?>
								</table>
							</center><br><br>
						</div>
